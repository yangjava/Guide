...
为了保持简单，组件的必填参数就两个。业务中的 AOP 逻辑大部分是使用 [@Aspect](https://my.oschina.net/aspect) 注解实现的，但是基于注解的 AOP 在 Spring boot 1.5 中兼容性是有问题的，组件为了兼容 Spring boot1.5 的版本我们手工实现 Spring 的 AOP 逻辑。
...
- [Canal](https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fgithub.com%2Falibaba%2Fcanal)
- [spring-framework](https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fspring.io%2Fprojects%2Fspring-framework)
- [Spring Expression Language (SpEL)](https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fdocs.spring.io%2Fspring-framework%2Fdocs%2F3.2.x%2Fspring-framework-reference%2Fhtml%2Fexpressions.html)
- [ThreadLocal、InheritableThreadLocal、TransmittableThreadLocal三者之间区别](https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fblog.csdn.net%2Fweixin_43954303%2Farticle%2Fdetails%2F113837928%3Fspm%3D1001.2014.3001.5501)