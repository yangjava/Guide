...
# [SQLite学习手册(实例代码<一>)](https://www.cnblogs.com/orangeform/archive/2012/03/05/2340780.html)
...
48     printf("The column count is %d.\n",fieldCount);
...
# [SQLite学习手册(实例代码<二>)](https://www.cnblogs.com/orangeform/archive/2012/03/07/2341480.html)
...
```
 ...
 42     if (sqlite3_prepare_v2(conn,beginSQL,strlen(beginSQL),&stmt2,NULL) != SQLITE_OK) {
 43         if (stmt2)
